...
public class RaycastRendererPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        responsiveCheckbox.setText("Be responsive (faster)");
        responsiveCheckbox.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                responsiveCheckboxActionPerformed(evt);
            }
        });
    ...
    private void mipButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mipButtonActionPerformed
        this.renderer.setCurrentMode(RaycastRenderer.MODE_MIP);
    ...
    private void slicerButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_slicerButtonActionPerformed
        this.renderer.setCurrentMode(RaycastRenderer.MODE_SLICER);
        this.renderer.changed();
    ...
    private void compositingButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compositingButtonActionPerformed
        this.renderer.setCurrentMode(RaycastRenderer.MODE_COMPOSITING);
        this.renderer.changed();
    ...
    private void tf2dButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf2dButtonActionPerformed
        this.renderer.setCurrentMode(RaycastRenderer.MODE_2DTRANSFER);
        this.renderer.changed();
    ...
    private void shadingCheckboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_shadingCheckboxActionPerformed
        this.renderer.setShading(this.shadingCheckbox.isSelected());
        this.renderer.changed();
    }//GEN-LAST:event_shadingCheckboxActionPerformed

    private void responsiveCheckboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_responsiveCheckboxActionPerformed
        //If checked go faster
        // else be accurate
        this.renderer.setResponsive(this.responsiveCheckbox.isSelected());
        this.renderer.changed();
    }//GEN-LAST:event_responsiveCheckboxActionPerformed
